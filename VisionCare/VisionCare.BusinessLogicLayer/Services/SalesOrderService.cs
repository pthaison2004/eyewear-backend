...
public class SalesOrderService : ISalesOrderService
{
    ...
    {
        var prescriptionItems = order.OrderItems
            .Where(i => i.PrescriptionId.HasValue)
            .ToList();
        ...
        return new SalesOrderDetailDto
        {
            ...
            HasPrescription = prescriptionItems.Any(),
            IsPrescriptionVerified = prescriptionItems.Any() &&
                prescriptionItems.All(i => i.Prescription?.IsVerified == true),
            Items = order.OrderItems.Select(i => new SalesOrderItemDto
            {
                ...
                PrescriptionNote = i.Prescription?.Note,
